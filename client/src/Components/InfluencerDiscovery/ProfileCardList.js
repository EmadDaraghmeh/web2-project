    ...
    <div className="cont">
      <div className="row">
        {influencers?.map(influencer => (
          <div className="col-md-6 mb-3" key={influencer?._id}>
            <div className="profile-card" id="PROFC">
              <span className="influencer-location" id="INFL">
                  ...
                  <div key={details._id} className={`social-icon ${platform}`}>
                    ...
                    {platform === 'twitter' && (
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter" viewBox="0 0 16 16">
                        <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.01-.422A6.674 6.674 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.3 3.3 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.084.797 3.28 3.28 0 0 0-5.594 2.994 9.325 9.325 0 0 1-6.766-3.429 3.287 3.287 0 0 0 1.016 4.384A3.266 3.266 0 0 1 .64 6.575v.045a3.285 3.285 0 0 0 2.633 3.218 3.203 3.203 0 0 1-.865.115c-.212 0-.423-.02-.626-.057a3.283 3.283 0 0 0 3.065 2.277A6.588 6.588 0 0 1 .781 13.58 6.32 6.32 0 0 1 0 13.555a9.287 9.287 0 0 0 5.026 1.465"/>
                      </svg>
                    )}
                    {platform === 'youtube' && (
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-youtube" viewBox="0 0 16 16">
                        <path d="M8.051 1.999h-.002C3.675 2.027 0 2.676 0 8.005 0 13.324 3.675 13.973 8.049 14h.002c4.375-.027 8.049-.676 8.049-5.995 0-5.319-3.675-5.973-8.049-6.006zm3.689 6.818l-5.5 3.114a.624.624 0 0 1-.938-.531v-6.23a.625.625 0 0 1 .938-.532l5.5 3.115a.624.624 0 0 1 0 1.064z"/>
                      </svg>
                    )}
                    {platform === 'snapchat' && (

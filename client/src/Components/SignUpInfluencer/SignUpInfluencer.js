...
const SignUpInfluencer = () => {
  ...
  const validateInput = (id, value) => {
    ...
    if (id === 'userName') {
      ...
      error.confirmPassword = value !== formData.password ? 'Passwords do not match.' : '';
    } else if (id === 'countryCode') {
      error.countryCode = value.trim() === '' ? 'Country code is required.' : '';
    } else if (id === 'phoneNumber') {
      const phonePattern = /^[0-9]+$/;
      error.phoneNumber = !phonePattern.test(value) ? 'Please enter a valid phone number.' : '';
    } else if (id === 'price') {
  ...
  const handleSubmit = async (e) => {
    ...
    axios.post('http://localhost:4000/signupinfluencer', formData)
      .then(res => {
        ...
        <div className="card-body">
          <form className="d-flex flex-column gap-4" onSubmit={handleSubmit} >
            <div className="row g-3">
              <div className="col">
                <label htmlFor="firstname" className="form-label" id="form-label1">userName</label>
                <input type="text" className="form-control" id="userName" placeholder="userName" aria-label="First name"
            ...
            <div className="row g-3">
              ...
              <div className="col-md-6">
                <label htmlFor="industry" className="form-label" id="form-label11">Industry</label>
            ...
            <div className="row g-3">
              ...
              <div className="col-md-6">
                <label htmlFor="Price" className="form-label" id="form-label12">Min Price</label>
            ...
            <div className="row g-3">
              ...
              <div className="col-md-3">
                ...
                <select id="country" className="form-select" value={formData.country} onChange={handleChange}>
                  <option>Choose...</option>

...
export default function Blog() {
  ...
  useEffect(() => {
    axios.get('http://localhost:4000/Blog')
      ...
      .catch(error => { 
        console.error('Error fetching the blog data', error.response);
      });
  }, []);
  ...
  return (
    <div className="blog">
      ...
      <div className="cards-container">
        ...
        <div className="middle-cards-blog">
     ...
     <Link className='group-link' to="/BlogPost">
      <div className="group">
